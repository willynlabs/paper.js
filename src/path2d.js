...
/*
 * path2d.js allows this to be used as a Path modeling library (vs. an interactive app framework).
 * by John Lynch March 2020
 */

// Allow the minification of the undefined variable by defining it as a local
// parameter inside the paper scope.
var path2d = function(self, undefined) {
    /*#*/ include('init.js');
...
// var Point = Base.extend(...);
    ...
    /*#*/ include('view/Path2dProxyView.js');
